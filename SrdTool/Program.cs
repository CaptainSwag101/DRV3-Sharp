...
namespace SrdTool
{
    class Program
    {
        ...
        {
            Console.WriteLine("SRD Tool by CaptainSwag101 + navigation\n" +
            ...
            string[] a = { "Print Blocks", "Extract Fonts", "Extract Models", "Extract Textures", "Replace Textures", "Save", "Exit" };
